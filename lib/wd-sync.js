...
(function() {
  var EventEmitter, MakeSync, Sync, Wd, WdWrap, buildOptions, k, mixedArgsMethods, patch, prototypeMethods, v, wd, wdSync, _ref,
    __slice = [].slice;
  ...
  buildOptions = function(mode) {
    ...
    return {
      mode: mode,
      include: '*',
      exclude: mixedArgsMethods.concat(prototypeMethods.concat(['getOpts', 'defaultElement']))
    };
  };
