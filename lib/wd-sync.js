...
(function() {
  var EventEmitter, current, eventEmitterMethods, k, makeSync, mixedArgsMethods, patch, sync, syncOptions, v, wd, wdSync, wrapAsyncObject, wrapSyncObject, _ref,
    __slice = [].slice;
  ...
  wdSync = {
    ...
    sleep: function(ms) {
      ...
      return fiber.constructor["yield"]();
    },
